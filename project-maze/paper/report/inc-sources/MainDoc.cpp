...
#ifdef _DEBUG
void CMFC_MainDoc::AssertValid() const { CDocument::AssertValid(); }

void CMFC_MainDoc::Dump(CDumpContext &dc) const { CDocument::Dump(dc); }
#endif //_DEBUG
...
void CMFC_MainDoc::OnFileClose() {
    ...
    DeleteContents();
    SetPathName("C:\\", FALSE);
    AfxGetApp()->m_pMainWnd->SetWindowText("������� - MFC_Main");
